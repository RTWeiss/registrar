...
ActiveRecord::Schema.define(version: 20151030005228) do
  ...
  add_index "collaborations", ["domain_id"], name: "index_collaborations_on_domain_id", using: :btree
  ...
  add_foreign_key "collaborations", "domains"
